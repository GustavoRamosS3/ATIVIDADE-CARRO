  ...
  return (
    <View style={estilo.container}>
      <Image
          ...
          style={estilo.header}
       />
          <Text style={estilo.title}>Bem-vindo a nossa concessionária</Text>
       <View style={estilo.Textos}>
          ...
          <Text style={[estilo.Text, estilo.marginTop]}>Sinta-se à vontade para navegar e descobrir tudo o que temos a oferecer. Se precisar de ajuda, nossa equipe está pronta para atendê-lo.</Text>
       </View>
